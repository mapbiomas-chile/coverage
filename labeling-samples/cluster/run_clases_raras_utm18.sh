#!/usr/bin/env bash
# Etiqueta clases raras zona UTM18: extrae mosaicos sieved y genera GeoPackage
set -euo pipefail
...
echo ""
echo "=========================================="
echo " PASO 2: Generar GeoPackage clases raras UTM18"
echo "=========================================="
...
echo "  ${LABELS_DIR}/raster/rare_classes/UTM18/{year}.tif"
echo "  ${LABELS_DIR}/vector/rare_classes/UTM18/rare_class_samples_UTM18.gpkg"
