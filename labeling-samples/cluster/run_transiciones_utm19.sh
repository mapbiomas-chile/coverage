#!/usr/bin/env bash
# Etiqueta rectángulos transición zona UTM19: extrae mosaicos sieved y genera GeoPackage
set -euo pipefail
...
echo ""
echo "=========================================="
echo " PASO 2: Generar GeoPackage transiciones UTM19"
echo "=========================================="
...
echo "  ${LABELS_DIR}/raster/transition/UTM19/{year}.tif"
echo "  ${LABELS_DIR}/vector/transition/UTM19/transition_samples_UTM19.gpkg"
