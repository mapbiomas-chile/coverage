#!/usr/bin/env bash
# Etiqueta rectángulos anuales zona UTM19: extrae mosaicos sieved y genera GeoPackage
set -euo pipefail
...
echo ""
echo "=========================================="
echo " PASO 2: Generar GeoPackage anuales UTM19"
echo "=========================================="
...
echo "  ${LABELS_DIR}/raster/annual/UTM19/{year}.tif"
echo "  ${LABELS_DIR}/vector/annual/UTM19/annual_samples_UTM19.gpkg"
