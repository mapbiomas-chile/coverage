...
from src.evaluation.qa import build_pilot_band_sets, evaluate_holdout_band_sets, load_col2_eco
...
def main() -> None:
    ...
    X_tr, y_tr = load_col2_eco(args.train_npz, args.train_index, args.eco_id, exclude_classes=exclude)
    X_va, y_va = load_col2_eco(args.val_npz, args.val_index, args.eco_id, exclude_classes=exclude)
